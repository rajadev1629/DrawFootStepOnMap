        ...
        switch (type) {
            ...
            case "A":
                ...
                polyline.setStartCap(
                        new CustomCap(
                                BitmapDescriptorFactory.fromResource(android.R.drawable.arrow_down_float), 10));
                break;
            case "B":
    ...
    private void captureScreen() {
        GoogleMap.SnapshotReadyCallback callback = new GoogleMap.SnapshotReadyCallback() {
            ...
            public void onSnapshotReady(Bitmap snapshot) {
                ...
                File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "map_demo");
                if (!mediaStorageDir.exists()) {
                    if (!mediaStorageDir.mkdirs()) {
                        Log.e("onSnapshotReady: ", "directory not created");
                        return;
                    }
                }
                ...
                final File file = new File(mediaStorageDir.getAbsolutePath(), "/" + "map" + timeStamp + ".png");
                try {
